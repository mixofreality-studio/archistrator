...
require (
	...
	github.com/mixofreality-studio/archistrator-platform/framework-go-app-generator v0.5.0
...
require (
	...
	github.com/mixofreality-studio/archistrator-platform/framework-go v0.4.5
