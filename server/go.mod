...
require (
	...
	github.com/mixofreality-studio/archistrator-platform/framework-go v0.4.3
	github.com/mixofreality-studio/archistrator-platform/framework-go-infrastructure-github v0.1.2
