...
// (operationsManager.md §6.4). The ResourceAccess ports return framework-go layer
...
// non-retryable port failures (NotFound / ContractMisuse / Auth / Conflict) surface
// to Temporal as terminal errors of the canonical Type(), and the
// retryable kinds (Transient / Infrastructure / RateLimited) stay retryable.
