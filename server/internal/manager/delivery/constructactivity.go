...
func (wf *csWorkflows) ConstructActivityWorkflow(ctx workflow.Context, in constructActivityInput) error {
...
func (wf *csWorkflows) runAttempt(
	ctx workflow.Context,
	in constructActivityInput,
	attempt int,
...
func (wf *csWorkflows) failVarianceExhausted(
	ctx workflow.Context,
	in constructActivityInput,
	headVersion *projectstate.Version,
	state *constructState,
...
func (wf *csWorkflows) runPipeline(ctx workflow.Context, in constructActivityInput, phase projectstate.ActivityMethodPhase, state *constructState, gf *gitForward, headVersion *projectstate.Version) (csPipelineObservation, error) {
	...
	for range maxPipelinePolls {
		...
		if _, cerr := wf.observeCIAndRecord(ctx, in, gf, headVersion); cerr != nil {
			return csPipelineObservation{}, cerr
		}
		...
		if obs.Phase == PipelineSucceeded || obs.Phase == PipelineFailed {
			...
			if rerr := wf.resolveWorkAttempt(ctx, in, state, headVersion, gf.cred, task, attempt, attemptID, obs); rerr != nil {
				return csPipelineObservation{}, rerr
			}
			return obs, nil
		}
		last = obs
	...
	return csPipelineObservation{Phase: exhausted.Phase, Diagnostic: exhausted.Diagnostic}, nil
}
...
func (wf *csWorkflows) runPhaseGate(
	ctx workflow.Context,
	in constructActivityInput,
...
func (wf *csWorkflows) gateWithoutHuman(
	ctx workflow.Context,
	in constructActivityInput,
	phase projectstate.ActivityMethodPhase,
	state *constructState,
...
func (wf *csWorkflows) awaitPhaseDecision(
	ctx workflow.Context,
	in constructActivityInput,
	phase projectstate.ActivityMethodPhase,
	state *constructState,
...
func (wf *csWorkflows) sendBackGate(
	ctx workflow.Context,
	in constructActivityInput,
	phase projectstate.ActivityMethodPhase,
	state *constructState,
...
func (wf *csWorkflows) completePhase(
	ctx workflow.Context,
	in constructActivityInput,
	phase projectstate.ActivityMethodPhase,
	state *constructState,
...
func (wf *csWorkflows) openGateRound(
	ctx workflow.Context,
	in constructActivityInput,
	phase projectstate.ActivityMethodPhase,
	state *constructState,
...
func (wf *csWorkflows) runLocalMergeStep(
	ctx workflow.Context,
	in constructActivityInput,
	attempt int,
	policy projectstate.ReviewPolicy,
	...
	// csWorkflows in flight before this feature deployed have no history for the
...
func (wf *csWorkflows) recordPhaseStarted(ctx workflow.Context, in constructActivityInput, phase projectstate.ActivityMethodPhase, state *constructState, seed projectstate.Version, cred railCredEnvelope) (projectstate.Version, error) {
...
func (wf *csWorkflows) handleVariance(
	ctx workflow.Context,
	in constructActivityInput,
...
func (wf *csWorkflows) executeOverride(
	ctx workflow.Context,
	in constructActivityInput,
...
func (wf *csWorkflows) awaitOverrideBounded(ctx workflow.Context, overrideCh workflow.ReceiveChannel) (operatorOverrideSignal, bool) {
...
func (wf *csWorkflows) recordActivityFailed(ctx workflow.Context, in constructActivityInput, seed projectstate.Version, reason projectstate.FailureReason, detail string, cred railCredEnvelope) (projectstate.Version, error) {
	return wf.applyRecovering(ctx, in.ProjectID, seed, func(expected projectstate.Version) (projectstate.Version, error) {
