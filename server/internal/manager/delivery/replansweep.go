...
func (wf *csWorkflows) ReplanSweepWorkflow(ctx workflow.Context, in replanSweepInput) (ReplanSweepResult, error) {
...
func (wf *csWorkflows) flagVariances(_ projectstate.Project) []FlaggedVariance {
	return nil
}
