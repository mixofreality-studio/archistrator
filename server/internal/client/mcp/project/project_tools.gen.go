...
// Handler binds the ProjectManager manager to MCP tools.
type Handler struct {
...
func (h *Handler) Register(srv *mcp.Server) {
	mcp.AddTool(srv, &mcp.Tool{Name: "projectCreateProject", Description: "CreateProject on the Project manager."}, h.handleCreateProject)
	mcp.AddTool(srv, &mcp.Tool{Name: "projectGetProject", Description: "GetProject on the Project manager."}, h.handleGetProject)
	mcp.AddTool(srv, &mcp.Tool{Name: "projectListProjects", Description: "ListProjects on the Project manager."}, h.handleListProjects)
}
