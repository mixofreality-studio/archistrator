...
func (h *Handler) Register(srv *mcp.Server) {
	...
	mcp.AddTool(srv, &mcp.Tool{Name: "systemDesignSubmitReviewDecision", Description: "SubmitReviewDecision on the SystemDesign manager."}, h.handleSubmitReviewDecision)
}
