...
func TestRender_ServerEnvMatchesProductionVariableNames(t *testing.T) {
	...
	for _, name := range []string{
		...
		"ARCHISTRATOR_WORKER_PROVIDER",
		"ARCHISTRATOR_ANTHROPIC_MODEL",
		"ARCHISTRATOR_ANTHROPIC_ARCHITECT_MODEL",
		"ARCHISTRATOR_ANTHROPIC_CRITIQUE_MODEL",
