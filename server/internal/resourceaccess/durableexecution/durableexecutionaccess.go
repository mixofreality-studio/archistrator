...
// ParseExecutionHandle. A free function because the generated contract type
// carries no methods.
...
// ExecutionHandleEqual reports value equality of two handles.
...
// ExecutionStatusString returns the stable name (logs, audit). A free function
...
// ExecutionStatus "running" and "suspended awaiting a signal" are deliberately
// collapsed into StatusRunning — suspend is a technical sub-state with no
// business consumer (the architect-review-gate UI reads the BUSINESS
