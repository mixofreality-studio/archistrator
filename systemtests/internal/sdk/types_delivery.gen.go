...
type StartProjectResult struct {
	ProjectID ProjectID       `json:"projectId"`
	Version   DeliveryVersion `json:"version"`
...
// ProjectRunStateName returns the declared varname of a ProjectRunState value.
func ProjectRunStateName(v ProjectRunState) string {
	switch v {
	case ProjectRunning:
...
// ProjectSessionStageName returns the declared varname of a ProjectSessionStage value.
func ProjectSessionStageName(v ProjectSessionStage) string {
	switch v {
	case ProjectSessionStageUnknown:
		return "ProjectSessionStageUnknown"
	case ProjectStageDrafting:
		return "ProjectStageDrafting"
	case ProjectStageAssemblingSDP:
		return "ProjectStageAssemblingSDP"
	case ProjectStageAwaitingReview:
		return "ProjectStageAwaitingReview"
	case ProjectStageRedrafting:
		return "ProjectStageRedrafting"
	case ProjectStageCommitted:
		return "ProjectStageCommitted"
	case ProjectStageWithdrawn:
		return "ProjectStageWithdrawn"
	case ProjectStageRefused:
		return "ProjectStageRefused"
	case ProjectStageDraftFailed:
		return "ProjectStageDraftFailed"
	default:
		return ""
	}
}

// ProjectViewKindName returns the declared varname of a ProjectViewKind value.
func ProjectViewKindName(v ProjectViewKind) string {
	switch v {
	case ProjectViewSummary:
		return "ProjectViewSummary"
	case ProjectViewProjects:
		return "ProjectViewProjects"
	case ProjectViewSession:
		return "ProjectViewSession"
	case ProjectViewPump:
		return "ProjectViewPump"
	case ProjectViewDesignHealth:
		return "ProjectViewDesignHealth"
	case ProjectViewEpisodes:
		return "ProjectViewEpisodes"
...
func ReviewDecisionName(v ReviewDecision) string {
	...
	case ReviewSetCommentStatus:
		return "ReviewSetCommentStatus"
	default:
		return ""
	}
}

// ReviewVerdictKindName returns the declared varname of a ReviewVerdictKind value.
func ReviewVerdictKindName(v ReviewVerdictKind) string {
	switch v {
	case VerdictApprove:
...
// SessionStageName returns the declared varname of a SessionStage value.
func SessionStageName(v SessionStage) string {
	switch v {
